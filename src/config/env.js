...
export const env = {
  ...
  TRANSLATION_SERVICE_URL: (process.env.TRANSLATION_SERVICE_URL || "http://127.0.0.1:8010").replace(/\/+$/, ""),
  TRANSLATION_SERVICE_API_KEY: (process.env.TRANSLATION_SERVICE_API_KEY || "").trim(),
  TRANSLATION_SERVICE_TIMEOUT_MS: Number.parseInt(process.env.TRANSLATION_SERVICE_TIMEOUT_MS || "20000", 10),
